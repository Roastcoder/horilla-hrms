...
def attendance_search(request):
    """
    This method is used to search attendances including call attendance data
    """
    ...
    validate_attendances_ids, ot_attendances_ids, attendances_ids, call_attendances_ids = [], [], [], []
    if field != "" and field is not None:
        ...
        call_attendances_ids = json.dumps(
            [instance.id for instance in call_attendances.object_list]
        )
    return render(
        request,
        template,
        {
            ...
            "call_attendances": call_attendances,
