...
urlpatterns = [
    # Call Attendance URLs - include with proper namespace
    path("call-attendance/", include(("attendance.call_attendance_urls", "call_attendance"), namespace="call_attendance")),
    # Call Attendance API URLs
    path("api/call-attendance/", include("attendance.call_attendance_api_urls")),
    path(
    ...
    # Test URL for creating sample call attendance data
    path(
        "test/create-sample-call-attendance/",
        test_views.create_sample_data,
        name="create-sample-call-attendance",
    ),
]
