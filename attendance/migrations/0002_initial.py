...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='historicalcallattendance',
            name='created_by',
        ...
        migrations.AddField(
            ...
            field=models.ForeignKey(db_constraint=False, on_delete=django.db.models.deletion.DO_NOTHING, related_name='history_set', to='attendance.callattendance'),
        ),
        migrations.AddField(
            model_name='historicalcallattendance',
            name='history_tags',
        ...
        migrations.AddField(
            model_name='historicalcallattendance',
            name='updated_by',
            field=models.ForeignKey(blank=True, db_constraint=False, null=True, on_delete=django.db.models.deletion.DO_NOTHING, related_name='+', to='employee.employee', verbose_name='Updated By'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='calllog',
            name='employee_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='call_logs', to='employee.employee', verbose_name='Employee'),
        ),
        migrations.AddField(
            model_name='calllog',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='callattendanceconfig',
            name='created_by',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By'),
        ),
        migrations.AddField(
        ...
        migrations.AddField(
            model_name='callattendanceaudit',
            name='call_attendance',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='audit_logs', to='attendance.callattendance', verbose_name='Call Attendance'),
        ),
        migrations.AddField(
            model_name='callattendanceaudit',
            name='created_by',
        ...
        migrations.AddField(
            model_name='callattendanceaudit',
            name='updated_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='audit_updates', to='employee.employee', verbose_name='Updated By'),
        ),
        migrations.AddField(
            model_name='callattendance',
            name='created_by',
            field=models.ForeignKey(blank=True, editable=False, null=True, on_delete=django.db.models.deletion.SET_NULL, to=settings.AUTH_USER_MODEL, verbose_name='Created By'),
        ),
        migrations.AddField(
            model_name='callattendance',
            name='employee_id',
            field=models.ForeignKey(on_delete=django.db.models.deletion.PROTECT, related_name='call_attendances', to='employee.employee', verbose_name='Employee'),
        ),
        migrations.AddField(
            model_name='callattendance',
            name='modified_by',
        ...
        migrations.AddField(
            model_name='callattendance',
            name='updated_by',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.PROTECT, related_name='updated_call_attendances', to='employee.employee', verbose_name='Updated By'),
        ),
        migrations.AddField(
